...
class EnsurePurchaseOrderSchema extends Migration
{
    public function up(): void
    {
        if ($this->db->tableExists('purchase_orders')) {
            ...
            $this->addIfMissing($fields, 'po_no', ['type' => 'VARCHAR', 'constraint' => 60, 'null' => true]);
            $this->addIfMissing($fields, 'po_date', ['type' => 'DATE', 'null' => true]);
            $this->addIfMissing($fields, 'supplier_id', ['type' => 'BIGINT', 'unsigned' => true, 'null' => true]);
            $this->addIfMissing($fields, 'supplier_name', ['type' => 'VARCHAR', 'constraint' => 180, 'null' => true]);
