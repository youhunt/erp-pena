...
class AllocationDeliveryLinkColumns extends Migration
{
    public function up(): void
    {
        ...
        $this->ensureColumn('allocationorder', 'delivered_by', 'BIGINT UNSIGNED NULL');
        ...
        $this->ensureIndex('allocationorder', 'idx_allocationorder_delivery_id', 'delivery_id');
