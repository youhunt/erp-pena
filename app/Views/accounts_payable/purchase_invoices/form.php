    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?= site_url('purchase/receipts/' . $receipt['id']) ?>" class="btn btn-light"><i class="bx bx-arrow-back me-1"></i> Back to Receipt</a>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="alert alert-info py-2">
                Posting invoice ini akan membuat A/P payable dari receipt yang sudah posted.
            </div>
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary" onclick="return confirm('Post purchase invoice ini dan buka A/P payable?')"><i class="bx bx-receipt me-1"></i> Post Invoice & Open A/P</button>
