...
<div class="card">
    <div class="card-body">
        ...
        <form method="get" action="<?= site_url('ar/sales-invoices') ?>" class="row g-2 align-items-end mb-4">
            <div class="col-md-5">
                <label class="form-label">Search</label>
                <input type="text" name="q" value="<?= esc($filters['q'] ?? '') ?>" class="form-control" placeholder="Invoice no, delivery no, customer">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-4 d-flex gap-2">
                ...
                <a href="<?= site_url('ar/sales-invoices') ?>" class="btn btn-light"><i class="bx bx-reset me-1"></i> Reset</a>
            </div>
        </form>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <?php if ((float) ($invoice['outstanding_amount'] ?? 0) > 0): ?>
                                <a href="<?= site_url('ar/sales-invoices/' . $invoice['id'] . '/receipt') ?>" class="btn btn-sm btn-outline-success">Receive</a>
                            <?php endif ?>
                        </td>
                    </tr>
                <?php endforeach ?>
