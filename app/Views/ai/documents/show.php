...
$canConvert = $canReview && (($extraction['review_status'] ?? '') === 'reviewed');
            ...
            <div class="card-body">
                ...
                <div class="mt-3 d-flex flex-wrap gap-2">
                    ...
                    <?php if ($canConvert): ?>
                        ...
                        <form method="post" action="<?= site_url('ai-documents/' . $document['id'] . '/convert-so') ?>" class="d-inline">
                            <?= csrf_field() ?>
                            <button type="submit" class="btn btn-info" onclick="return confirm('Convert reviewed extraction to Sales Order?')">
                                <i class="bx bx-transfer-alt me-1"></i> Convert to SO
                            </button>
                        </form>
                    <?php endif ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php elseif ($canConvert): ?>
                    <div class="alert alert-success mb-0">Document has been reviewed and is ready to convert to Purchase Order or Sales Order.</div>
