...
<div class="page">
    ...
    <table class="lines">
        <thead>
            <tr>
                ...
                <?php if ($showLineCommercial): ?>
                    <th class="text-end" style="width:82px;">Disc</th>
                    <th class="text-end" style="width:82px;">Tax</th>
                <?php endif ?>
        ...
        <?php endforeach ?>
        <?php if (($lines ?? []) === []): ?>
            <tr><td colspan="<?= (int) $lineColspan ?>" class="text-center muted">No line data.</td></tr>
        <?php endif ?>
        </tbody>
    </table>
    ...
    <div class="signatures">
        <?php foreach ($signatures as $signature): ?>
            <div class="signature"><div class="line"><?= esc($signature) ?></div></div>
        <?php endforeach ?>
    </div>
</div>
<script>
