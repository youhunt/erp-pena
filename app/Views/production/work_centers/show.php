            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                    <div>
                        ...
                        <p class="text-muted mb-0"><?= esc($workCenter['work_center_code']) ?></p>
                    </div>
                ...
                <div class="mt-3"><a href="<?= site_url('production/work-centers') ?>" class="btn btn-light"><i class="bx bx-arrow-back me-1"></i> Back</a></div>
            </div>
        </div>
    </div>
    <div class="col-xl-8">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap align-middle mb-0">
                        <thead class="table-light"><tr><th>No</th><th>Machine</th><th>Notes</th><th class="text-end">Speed</th><th class="text-end">Capacity</th><th class="text-end">Labor</th><th class="text-end">Hour</th></tr></thead>
                        <tbody>
                        <?php foreach ($machines as $machine): ?>
                            <tr>
                                ...
                                <td class="text-end"><?= esc(number_format((float) $machine['speed'], 3)) ?></td>
                                <td class="text-end"><?= esc(number_format((float) $machine['capacity'], 3)) ?></td>
                                <td class="text-end"><?= esc(number_format((float) $machine['qtylabor'], 4)) ?></td>
                                <td class="text-end"><?= esc(number_format((float) $machine['workhour'], 3)) ?></td>
                            </tr>
                        <?php endforeach ?>
                        <?php if ($machines === []): ?><tr><td colspan="7" class="text-center text-muted py-4">No machine detail.</td></tr><?php endif ?>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap align-middle mb-0">
                        ...
                        <?php endforeach ?>
                        <?php if ($costs === []): ?><tr><td colspan="4" class="text-center text-muted py-4">No cost detail.</td></tr><?php endif ?>
                        </tbody>
                    </table>
                </div>
            </div>
