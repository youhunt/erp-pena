...
<div class="card">
    <div class="card-body">
        ...
        <form method="get" action="<?= site_url('purchase/orders') ?>" class="row g-2 align-items-end mb-4">
            <div class="col-md-5">
                <label class="form-label">Search</label>
                <input type="text" name="q" value="<?= esc($filters['q'] ?? '') ?>" class="form-control" placeholder="PO no, supplier code, supplier name">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-4 d-flex gap-2">
                ...
                <a href="<?= site_url('purchase/orders') ?>" class="btn btn-light"><i class="bx bx-reset me-1"></i> Reset</a>
            </div>
        </form>
