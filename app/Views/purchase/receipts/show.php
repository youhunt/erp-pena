                ...
                <table class="table table-sm mb-0">
                    <tbody>
                        ...
                        <?php if ($status === 'reversed'): ?>
                            ...
                            <tr><th>Reason</th><td><?= esc($receipt['reversal_reason'] ?? '-') ?></td></tr>
                        <?php endif ?>
                    </tbody>
                </table>
                <div class="mt-3 d-flex flex-wrap gap-2">
                    ...
                    <?php if ($status === 'posted'): ?>
                        ...
                        <form method="post" action="<?= site_url('purchase/receipts/' . (int) $receipt['id'] . '/reverse') ?>" class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-warning" onclick="return confirm('Reverse this purchase receipt and decrease stock?')">Reverse</button>
                        </form>
                    <?php endif ?>
                </div>
            </div>
