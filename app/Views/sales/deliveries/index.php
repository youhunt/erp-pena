    ...
    <div class="card-body">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="<?= site_url('sales/deliveries/import') ?>" class="btn btn-outline-primary">
                    <i class="bx bx-upload me-1"></i> Import
                </a>
                <a href="<?= site_url('sales/deliveries/import-template') ?>" class="btn btn-outline-secondary">
        ...
        <form method="get" action="<?= site_url('sales/deliveries') ?>" class="row g-2 align-items-end mb-4">
            <div class="col-md-5">
                ...
                <input type="text" name="q" value="<?= esc($filters['q'] ?? '') ?>" class="form-control" placeholder="Delivery no, SO no, customer">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-4 d-flex gap-2">
                ...
                <a href="<?= site_url('sales/deliveries') ?>" class="btn btn-light"><i class="bx bx-reset me-1"></i> Reset</a>
            </div>
        </form>
                ...
                <?php foreach ($deliveries as $delivery): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <?php if (($delivery['status'] ?? '') === 'posted'): ?>
                                <a href="<?= site_url('sales/deliveries/' . $delivery['id'] . '/invoice') ?>" class="btn btn-sm btn-outline-success">Invoice</a>
                            <?php endif ?>
                        </td>
                    </tr>
                <?php endforeach ?>
