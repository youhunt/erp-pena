            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Upload CSV file for <?= esc($module) ?>.</p>
                    </div>
                    <a href="<?= site_url('system/data-import') ?>" class="btn btn-light">Back</a>
                </div>

                <div class="alert alert-warning">
                    Please download the template first and keep the header columns unchanged.
                </div>
                ...
                <form method="post" action="<?= esc($actionUrl) ?>" enctype="multipart/form-data">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Import this CSV file?')">
