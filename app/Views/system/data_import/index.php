            ...
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Download template, import CSV, and export ERP master/opening data.</p>
                    </div>
                    <span class="badge bg-primary">Phase 1 + Opening Stock</span>
                </div>

                <div class="alert alert-info mb-4">
                    <strong>Recommended flow:</strong> download template, fill data, import CSV, then review data in each module. Transaction imports such as PO/SO/Invoice should use preview and draft posting in later phases.
                </div>
                ...
                <div class="table-responsive mb-4">
                    <table class="table table-nowrap align-middle table-hover mb-0">
                        <thead class="table-light">
                            <tr><th>Group</th><th>Module</th><th>Route</th><th class="text-end">Actions</th></tr>
                        </thead>
                        <tbody>
                ...
                <h5 class="mb-3">Inventory Opening</h5>
                <div class="table-responsive mb-4">
                    <table class="table table-nowrap align-middle table-hover mb-0">
                        <thead class="table-light">
                            <tr><th>Group</th><th>Module</th><th>Route</th><th class="text-end">Actions</th></tr>
