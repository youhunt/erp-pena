...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <p class="text-muted mb-1">Development</p>
                <h4><?= esc((string) $overall['internal_development']) ?>%</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <p class="text-muted mb-1">Demo</p>
                <h4><?= esc((string) $overall['internal_demo']) ?>%</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <p class="text-muted mb-1">UAT</p>
                <h4><?= esc((string) $overall['uat_readiness']) ?>%</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="text-warning"><?= esc((string) $overall['production_readiness']) ?>%</h4>
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-4">
            <div>
                <h4 class="card-title mb-1">LENTERRA ERP Development Status</h4>
