...
| Phase 4 - Inventory Core | Partial | Stock balance, stock movement, stock adjustment, inventory stock service, average cost movement value, inventory adjustment GL posting, Inventory Transfer header-line workflow dengan audit status, inventory period close guard |
...
Sisa pekerjaan:
- Reversal dan period close process checklist belum lengkap.
